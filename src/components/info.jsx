          ...
          {
            {
              ...
              1:<Alert message="Your LTV (loan-to-value) is acceptable but higher than preferred. This could lead to a higher interest rate and may require the purchase of mortgage insurance." type="warning" />,
              2:<Alert message="Your LTV (loan-to-value) is too high. Increasing your down payment can lower this value." type="error" />,
            }[LTV]
          }
      </div>
      <div className="tips">
          {
            {
              ...
              1:<Alert message="Your DTI (debt-to-income) is acceptable but higher than preferred. " type="warning" />,
              2:<Alert message="Your DTI (debt-to-income) is too high. One way to lower your DTI would be to transfer high interest loans to a low interest credit card, although having too many cards can also negatively impact your ability to purchase a home." type="error" />,
            }[DTI]
          }
      </div>
      <div className="tips">
